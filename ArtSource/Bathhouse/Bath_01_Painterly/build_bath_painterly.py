...
body=finish_group('body','SM_Bath_01_Painterly_Body')
hardware=finish_group('metal','SM_Bath_01_Painterly_Hardware')
details=finish_group('detail','SM_Bath_01_Painterly_Details')
water=finish_group('water','SM_Bath_01_Painterly_Water')
...
def collision(loc,size):
    obj=box('UCX_SM_Bath_01_Painterly_Body_'+str(len(collisions)).zfill(2),loc,size,None,0,None,collision_col)
...
fbx('SM_Bath_01_Painterly_Body.fbx',[body]+collisions)
fbx('SM_Bath_01_Painterly_Hardware.fbx',[hardware,details])
fbx('SM_Bath_01_Painterly_Water.fbx',[water])
...
scene.render.filepath=str(ROOT/'Bath_01_Painterly_Hero.png')
select_only(asset_objects)
...
scene.render.filepath=str(ROOT/'Bath_01_Painterly_Empty.png')
bpy.ops.render.render(write_still=True)
water.hide_render=False
cam.location=(6.4,-8.8,7.4);point_at(cam,(0,-.24,.62));camdata.ortho_scale=7.65
scene.render.filepath=str(ROOT/'Bath_01_Painterly_Hero.png')
result={'saved':str(ROOT/'Bath_01_Painterly.blend'),'statistics':stats,'previews':['Bath_01_Painterly_Hero.png','Bath_01_Painterly_Empty.png']}
